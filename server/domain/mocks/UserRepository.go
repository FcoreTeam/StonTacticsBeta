...
// UpdateMetaData provides a mock function with given fields: c, email, name, avatarUrl
func (_m *UserRepository) UpdateMetaData(c context.Context, email string, name string, avatarUrl string) error {
	ret := _m.Called(c, email, name, avatarUrl)
